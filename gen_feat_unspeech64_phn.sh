...
#first phn model
run=models/1521509552phnfeats_transVgg16big_nsampling_same_spk_win32_neg_samples4_lcontexts2_rcontexts2_flts40_embsize100_fc_size2048_unit_norm_var_dropout_keep0.9_l2_reg0.0001_featinput_unnormalized.feats.ark_dot_combine/
...
python3 unsup_model_neg.py --gen_feats --train_dir $run  --filelist /srv/data/milde/kaldi/egs/tedlium/s5_r2/data/test_fbank/unnormalized.feats.ark  --num_filters $num_filters --embedding_transformation $embedding_transformation --num_highway_layers $num_highway_layers --embedding_size $embedding_size --num_dnn_layers $num_dnn_layers --hop_size $hop_size $additional_params --output_feat_file $outputdir/test/ivector_online

echo $genfeat_stride > $outputdir/test/ivector_period

echo "computing feats for train set... "
python3 unsup_model_neg.py --gen_feats --train_dir $run  --filelist /srv/data/milde/kaldi/egs/tedlium/s5_r2/data/train_cleaned_sp_hires_fbank_comb/unnormalized.feats.ark  --num_filters $num_filters --embedding_transformation $embedding_transformation --num_highway_layers $num_highway_layers --embedding_size $embedding_size --num_dnn_layers $num_dnn_layers --hop_size $hop_size $additional_params --output_feat_file $outputdir/train_cleaned_sp_comb/ivector_online

echo $genfeat_stride > $outputdir/train_cleaned_sp_comb/ivector_period

echo "computing feats for commonvoice dev set..."
python3 unsup_model_neg.py --gen_feats --train_dir $run  --filelist  /srv/data/milde/kaldi/egs/tedlium/s5_r2/data/valid_dev_fbank/feats.unnormalized.ark --num_filters $num_filters --embedding_transformation $embedding_transformation --num_highway_layers $num_highway_layers --embedding_size $embedding_size --num_dnn_layers $num_dnn_layers --hop_size $hop_size $additional_params --output_feat_file $outputdir/valid_dev/ivector_online
